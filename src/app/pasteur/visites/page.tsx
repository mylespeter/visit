                    ...
                    <tr key={visite.id} className="hover:bg-gray-50 transition">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-1">
                          <button
                            onClick={() => openNoteModal(visite)}
                            className="p-1 bg-purple-600 hover:bg-purple-700 rounded transition"
                            title="Note pastorale"
                          >
                            <FileText className="w-5 h-5 text-white" />
                          </button>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
            ...
            <div className="p-6">
              ...
              <textarea
                ...
                onChange={(e) => setAnnulerCommentaire(e.target.value)}
                rows={3}
                className="w-full px-3 py-2 text-sm border border-gray-300 focus:ring-2 focus:ring-red-500 focus:border-red-500 rounded-lg"
                placeholder="Raison de l'annulation..."
              />
            </div>
            <div className="border-t border-gray-200 px-6 py-4 flex justify-end gap-3">
      ...
      {showNoteModal && selectedVisite && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] flex flex-col">
            <div className="bg-gradient-to-r bg-blue-500 text-white px-6 py-4 rounded-t-lg">
              <div className="flex justify-between items-center">
                <div>
                  <h2 className="text-lg font-semibold flex items-center gap-2">
                    <FileText className="w-5 h-5" />
