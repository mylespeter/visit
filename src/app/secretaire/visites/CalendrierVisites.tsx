...
// // //   const [visitesDate, setVisitesDate] = useState<any[]>([])
...
// // //       isSelectable: false, // Mois précédent non sélectionnable
// // //       visitesCount: 0
// // //     })
// // //   }
...
// // //     const visitesCount = visites.filter(v => v.date_visite === date).length
...
// // //   const nextMonthDays = 42 - totalDays // 6 lignes * 7 jours = 42
...
// // //     const colors = {
// // //       'En attente': 'bg-gray-200',
// // //       'Confirmée': 'bg-gray-300',
// // //       'Reçue': 'bg-gray-400',
// // //       'Reportée': 'bg-gray-100',
// // //       'Annulée': 'bg-gray-50'
// // //     }
// // //     return colors[statut as keyof typeof colors] || 'bg-gray-100'
// // //   }
...
// // //           <div key={jour} className="text-center text-xs text-gray-400 py-2">
// // //             {jour}
// // //           </div>
// // //         ))}
...
// // //               ${day.isCurrentMonth ? 'text-gray-900' : 'text-gray-200'}
// // //               ${day.isSelectable 
// // //                 ? 'hover:bg-gray-50 cursor-pointer' 
// // //                 : 'cursor-default'
// // //               }
// // //               ${selectedDate === day.date ? 'ring-2 ring-gray-200' : ''}
// // //             `}
// // //           >
// // //             <span>{day.day}</span>
// // //             {day.visitesCount > 0 && (
...
// // //           <span className="text-gray-400">Mardi/Mercredi</span>
// // //         </div>
// // //         <div className="flex items-center gap-2">
...
// // //             <div className="w-1 h-1 rounded-full bg-gray-400" />
// // //           </div>
// // //           <span className="text-gray-400">Visites</span>
// // //         </div>
// // //       </div>
...
// // //               <p className="text-sm text-gray-300">Aucune visite</p>
// // //             </div>
// // //           ) : (
// // //             <div className="space-y-2">
// // //               {visitesDate.map((visite) => (
// // //                 <div key={visite.id} className="p-3 bg-gray-50 rounded-lg">
// // //                   <div className="flex items-center justify-between">
// // //                     <div>
// // //                       <span className="text-sm font-medium text-gray-900">
// // //                         {visite.heure}
// // //                       </span>
// // //                       <span className={`ml-2 text-xs px-2 py-0.5 rounded-full ${getStatutColor(visite.statut)}`}>
// // //                         {visite.statut}
// // //                       </span>
// // //                     </div>
// // //                   </div>
// // //                   <p className="text-sm text-gray-600 mt-1">{visite.nom_visiteur}</p>
// // //                   <p className="text-xs text-gray-400 mt-1">{visite.telephone} • {visite.motif}</p>
// // //                 </div>
// // //               ))}
// // //             </div>
// // //           )}
...
// //   // Premier jour du mois (1 = Lundi, 7 = Dimanche en France)
// //   const firstDay = new Date(year, month, 1)
// //   let startDay = firstDay.getDay()
// //   // Adapter pour que Lundi = 1, Dimanche = 7
...
// //   // Si une date est sélectionnée, utiliser les visites du jour
// //   useEffect(() => {
// //     if (selectedDate && visitesParDate[selectedDate]) {
// //       setVisitesDate(visitesParDate[selectedDate])
// //     }
// //   }, [selectedDate, visitesParDate])
...
// //                 <h3 className="text-sm font-medium text-gray-900">
// //                   Visites du {new Date(selectedDate).toLocaleDateString('fr-FR', {
// //                     weekday: 'long',
// //                     day: 'numeric',
// //                     month: 'long'
// //                   })}
