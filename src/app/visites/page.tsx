...
// //       motif: '',
// //       autre_motif: '',
// //       date_visite: format(currentDate, 'yyyy-MM-dd'),
// //       heure: '12:00',
// //       observations: ''
// //     });
// //   };
...
// //                             className="p-1 bg-blue-600 hover:bg-blue-700 rounded transition"
// //                             title="Modifier"
// //                           >
...
// import { useState, useEffect } from 'react';
// import { format, parseISO, addDays, subDays, getDay, setDate, addWeeks } from 'date-fns';
// import { fr } from 'date-fns/locale';
// import { 
//   Plus, 
//   CheckCircle, 
...
// function getNextValidDate(currentDate: Date): Date {
//   const dayOfWeek = getDay(currentDate);
//   // Dimanche=0, Lundi=1, Mardi=2, Mercredi=3, Jeudi=4, Vendredi=5, Samedi=6
  
//   if (dayOfWeek === 2 || dayOfWeek === 3) {
//     // Si c'est déjà mardi ou mercredi, retourner la date actuelle
//     return currentDate;
//   } else if (dayOfWeek < 2) {
//     // Dimanche ou Lundi -> prochain mardi
//     return addDays(currentDate, 2 - dayOfWeek);
//   } else {
//     // Jeudi, Vendredi, Samedi -> prochain mardi (ajouter des jours jusqu'à mardi prochain)
//     return addDays(currentDate, (9 - dayOfWeek));
//   }
// }
...
//   // Changement de date avec validation
//   const previousDay = () => {
//     let newDate = subDays(currentDate, 1);
//     // Si la nouvelle date n'est pas valide, continuer à reculer jusqu'à trouver une date valide
...
//     // Si la nouvelle date n'est pas valide, continuer à avancer jusqu'à trouver une date valide
//     while (!isValidVisitDate(newDate)) {
...
//     } else {
//       // Si aujourd'hui n'est pas valide, aller au prochain mardi ou mercredi
...
//       setDateError('');
//     } else {
//       // Proposer la prochaine date valide
//       const nextValidDate = getNextValidDate(selectedDate);
//       const nextValidDateStr = format(nextValidDate, 'yyyy-MM-dd');
      
//       setDateError(
//         `⚠️ Les visites pastorales ont lieu uniquement les MARDIS et MERCREDIS. ` +
//         `Date proposée : ${formatDateWithDay(nextValidDate)}`
//       );
      
//       // Optionnel : proposer de changer automatiquement
//       if (confirm(`Voulez-vous utiliser la date proposée : ${formatDateWithDay(nextValidDate)} ?`)) {
//         setFormData({...formData, date_visite: nextValidDateStr});
//         setDateError('');
//       }
//     }
//   };
...
//     if (!isValidVisitDate(selectedDate)) {
//       setError('❌ Les visites pastorales ont lieu uniquement les MARDIS et MERCREDIS. Veuillez sélectionner une date valide.');
//       setSubmitting(false);
//       return;
//     }
...
//   // Vérifier si la date actuelle est valide pour affichage
//   const currentDateIsValid = isValidVisitDate(currentDate);
...
//               <Calendar className="w-4 h-4" />
//               <span>
//                 {isToday && currentDateIsValid ? "Aujourd'hui" : formatDateWithDay(currentDate)}
//               </span>
//             </button>
...
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
//           {/* Total */}
//           <div className="bg-white shadow-sm rounded-lg py-3 px-5 border-l-4 border-blue-500 hover:shadow-md transition">
//             <div className="flex justify-between items-start">
//               <div>
//                 <p className="text-sm text-gray-500 mb-1">Total visites</p>
//                 <p className="text-2xl font-bold text-gray-800">{stats.total}</p>
...
//           {/* En attente */}
//           <div className="bg-white shadow-sm rounded-lg py-3 px-5 border-l-4 border-yellow-500 hover:shadow-md transition">
//             <div className="flex justify-between items-start">
//               <div>
//                 <p className="text-sm text-gray-500 mb-1">En attente</p>
//                 <p className="text-2xl font-bold text-gray-800">{stats.en_attente}</p>
...
//           {/* Reçues */}
//           <div className="bg-white shadow-sm rounded-lg py-3 px-5 border-l-4 border-green-500 hover:shadow-md transition">
//             <div className="flex justify-between items-start">
//               <div>
//                 <p className="text-sm text-gray-500 mb-1">Reçues</p>
//                 <p className="text-2xl font-bold text-gray-800">{stats.recus}</p>
...
//           {/* Annulées */}
//           <div className="bg-white shadow-sm rounded-lg py-3 px-5 border-l-4 border-red-500 hover:shadow-md transition">
//             <div className="flex justify-between items-start">
//               <div>
//                 <p className="text-sm text-gray-500 mb-1">Annulées</p>
//                 <p className="text-2xl font-bold text-gray-800">{stats.annules}</p>
...
//               <Calendar className="w-16 h-16 text-gray-300 mx-auto mb-4" />
//               <p className="text-gray-500">Aucune visite prévue pour cette journée</p>
//               {isToday && currentDateIsValid && pourcentage < 100 && (
//                 <button
//                   onClick={() => setShowModal(true)}
//                   className="mt-4 text-green-600 hover:text-green-700 font-medium inline-flex items-center gap-2"
//                 >
...
//             📅 Les visites pastorales ont lieu uniquement les <span className="font-semibold text-blue-600">MARDIS</span> et <span className="font-semibold text-blue-600">MERCREDIS</span>
//           </p>
//         </div>
//       </div>
...
//               <button
//                 onClick={marquerRecu}
//                 className="px-4 py-2 text-sm bg-green-600 hover:bg-green-700 text-white rounded-lg transition font-medium flex items-center gap-2"
//               >
//                 <Check className="w-4 h-4" />
//                 Marquer comme reçu
//               </button>
...
//               <button
//                 onClick={confirmerAnnulation}
//                 className="px-4 py-2 text-sm bg-red-600 hover:bg-red-700 text-white rounded-lg transition font-medium flex items-center gap-2"
//               >
//                 <X className="w-4 h-4" />
//                 Confirmer l'annulation
//               </button>
...
//             <form onSubmit={handleSubmit} className="p-6">
//               {error && (
//                 <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg text-sm mb-5 flex items-start gap-2">
...
//               {dateError && !error && (
//                 <div className="bg-yellow-50 border border-yellow-200 text-yellow-700 px-4 py-3 rounded-lg text-sm mb-5 flex items-start gap-2">
//                   <AlertCircle className="w-5 h-5 flex-shrink-0 mt-0.5" />
//                   <span>{dateError}</span>
//                 </div>
//               )}
...
//                   type="submit"
//                   disabled={submitting || (isToday && stats.total >= stats.quota && !editingVisite)}
//                   className="px-4 py-2 text-sm bg-green-600 hover:bg-green-700 text-white rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 font-medium"
//                 >
//                   {submitting && <Loader2 className="w-4 h-4 animate-spin" />}
//                   {editingVisite ? 'Mettre à jour' : 'Créer la visite'}
//                 </button>
